...
using zxing::xGlobalHistogramBinarizer;
...
xGlobalHistogramBinarizer::xGlobalHistogramBinarizer(Ref<LuminanceSource> source) 
  : Binarizer(source), luminances(EMPTY), buckets(LUMINANCE_BUCKETS) {}

xGlobalHistogramBinarizer::~xGlobalHistogramBinarizer() {}

void xGlobalHistogramBinarizer::initArrays(int luminanceSize) {
...
Ref<BitArray> xGlobalHistogramBinarizer::getBlackRow(int y, Ref<BitArray> row) {
...
Ref<BitMatrix> xGlobalHistogramBinarizer::getBlackMatrix() {
  LuminanceSource& source = *getLuminanceSource();
  int width = source.getWidth();
...
int xGlobalHistogramBinarizer::estimateBlackPoint(ArrayRef<int> const& buckets) {
...
Ref<Binarizer> xGlobalHistogramBinarizer::createBinarizer(Ref<LuminanceSource> source) {
  return Ref<Binarizer> (new xGlobalHistogramBinarizer(source));
}
