...
#ifndef __XGLOBALHISTOGRAMBINARIZER_H__
#define __XGLOBALHISTOGRAMBINARIZER_H__
/*
...
class xGlobalHistogramBinarizer : public Binarizer {
private:
...
#endif /* XGLOBALHISTOGRAMBINARIZER_H_ */
